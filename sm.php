 ...
 if(isset($_POST['buy']))
{
  ...
  $count=$res->num_rows;
  $count=$count+1;
  $sql="insert into cbill(Id,cust,item1,cost1,quantity1,total1,item2,cost2,quantity2,total2,item3,cost3,quantity3,total3,grandtotal) VALUES($count,'$s','$item1',$ct1,$qt1,$tc1,'$item2',$ct2,$qt2,$tc2,'$item3',$ct3,$qt3,$tc3,$tl)";
  $res=$con->query($sql);
   //if($res==true)
